...
@user_router.put("/loggedin/{logged_in_pk}", response_model=ResponseData, description="유저 로그인 기록 수정", summary="유저 로그인 기록 수정")
...
@user_router.put("/oauth/{oauth_pk}", response_model=ResponseData, description="유저 Oauth 수정", summary="유저 Oauth 수정")
...
@user_router.put("/managed/{managed_user_pk}", response_model=ResponseData, description="유저 관리자 수정", summary="유저 관리자 수정")
...
@user_router.put("/userrole/{user_role_pk}", response_model=ResponseData, description="유저 권한 수정", summary="유저 권한 수정")
