...
@board_router.get("/changelog/{changelog_pk}", response_model=ResponseData, description="특정 게시글 변경 이력 조회", summary="특정 게시글 변경 이력 조회")
...
@board_router.put("/changelog/{changelog_pk}", response_model=ResponseData, description="게시글 변경 이력 수정", summary="게시글 변경 이력 수정")
...
@board_router.delete("/changelog/{changelog_pk}", response_model=ResponseData, description="게시글 변경 이력 삭제", summary="게시글 변경 이력 삭제")
